...
export interface NicheConfig {
  ...
  icon: string;
  defaultCTA: string;
  itemLabel: string; // "plato", "servicio", "producto", etc.
}

export const NICHE_CONFIGS: Record<Niche, NicheConfig> = {
  restaurante: {
    id: "restaurante",
    label: "Restaurante / Gastro",
    icon: "🍽️",
    defaultCTA: "¡Hacé tu pedido!",
    itemLabel: "plato",
  },
  barberia: {
    id: "barberia",
  ...
  taller_mecanico: {
    ...
    icon: "🔧",
    defaultCTA: "Consultá presupuesto",
    itemLabel: "servicio",
  },
  catalogo_ropa: {
    id: "catalogo_ropa",
    label: "Catálogo de Ropa",
    icon: "👗",
    defaultCTA: "Comprá ahora",
    itemLabel: "prenda",
  },
  estudio_abogados: {
    id: "estudio_abogados",
    ...
    itemLabel: "área legal",
  },
  creador_contenido: {
    id: "creador_contenido",
    label: "Creador de Contenido",
    icon: "🎬",
    defaultCTA: "Colaboremos juntos",
    itemLabel: "servicio",
  },
  gimnasio: {
    id: "gimnasio",
  ...
  veterinaria: {
    ...
    label: "Veterinaria",
    icon: "🐾",
    defaultCTA: "Pedí turno para tu mascota",
    itemLabel: "servicio",
  },
  inmobiliaria: {
    id: "inmobiliaria",
    label: "Inmobiliaria",
    icon: "🏠",
    defaultCTA: "Consultá por esta propiedad",
    itemLabel: "propiedad",
  },
  floreria: {
    id: "floreria",
  ...
  lavanderia: {
    ...
    label: "Lavandería",
    icon: "🧺",
    defaultCTA: "Pedí retiro a domicilio",
    itemLabel: "servicio",
  },
  optica: {
    id: "optica",
    label: "Óptica",
    icon: "👓",
    defaultCTA: "Agendá tu examen visual",
    itemLabel: "producto",
  },
  ferreteria: {
    id: "ferreteria",
    label: "Ferretería",
    icon: "🛠️",
    defaultCTA: "Consultá disponibilidad",
    itemLabel: "producto",
  },
};
